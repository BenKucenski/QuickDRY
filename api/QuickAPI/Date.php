...
// http://webdesign.anmari.com/1956/calculate-date-from-day-of-year-in-php/
    ...
    public static function CalcWeek($date, $debug = false)
    {
        ...
        list($start_date, $end_date) = self::x_week_range($date);
    ...
    public static function FromUserTimeToGMT($time) {
        global $User;
    ...
    public static function EchoTime($msg)
    {
        echo time() . ': ' . self::Timestamp() . ': ' . $msg . PHP_EOL;
    }
     ...
     * @return int
     */
    public static function getTimeStampFromDBDate($date)
    {
