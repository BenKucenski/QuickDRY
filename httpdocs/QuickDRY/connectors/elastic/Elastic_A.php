 ...
 * Class Elastic
 */
class Elastic_A extends ElasticBase
{
    /**
     * @param      $where
     * @param int  $page
    ...
    public static function DeleteRemovedPropertiesV1()
    {
        return static::_DeleteRemoved('properties','v1');
    }

    public static function DeleteRemovedPropertiesV2()
    {
        return static::_DeleteRemoved('properties','v2');
    }
    ...
    public static function SearchQuery($index, $type, $query, $page = 0, $per_page = 20)
    {
        return static::_SearchQuery($index, $type, $query, $page, $per_page);
    }

    public static function SimpleSearch(
        $index, $type, $where, $page = 0, $per_page = 20, $order_by = null, $fields = null
    ) {
        return static::_SimpleSearch($index, $type, $where, $page, $per_page, $order_by, $fields);
    }

    public static function Search(
        $index, $type, $where, $page = 0, $per_page = 20, $order_by = null, $facets = null, $mincount = 0, $fq = null, $fields = null
    ) {
        return static::_Search($index, $type, $where, $page, $per_page, $order_by, $facets, $mincount, $fq, $fields);
    }
    ...
    protected static function _SimpleSearch(
        ...
        $array = @json_decode($res, true, 512, JSON_BIGINT_AS_STRING);
