...
class FineDiff
{
  ...
  public static array $paragraphGranularity = array(
    FineDiff::paragraphDelimiters
  );
  const sentenceDelimiters = ".\n\r";
  public static array $sentenceGranularity = array(
    FineDiff::paragraphDelimiters,
    FineDiff::sentenceDelimiters
  );
  const wordDelimiters = " \t.\n\r";
  public static array $wordGranularity = array(
    FineDiff::paragraphDelimiters,
    FineDiff::sentenceDelimiters,
    FineDiff::wordDelimiters
  );
  const characterDelimiters = "";
  public static array $characterGranularity = array(
    FineDiff::paragraphDelimiters,
    FineDiff::sentenceDelimiters,
    FineDiff::wordDelimiters,
