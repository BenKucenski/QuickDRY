...
class PHPExcel_Shared_Excel5
{
     ...
     * @internal param int $startOffset Offset within start cell measured in 1/1024 of the cell width
     * @internal param int $endOffset Offset within end cell measured in 1/1024 of the cell width
     */
     ...
     *
     * @param PHPExcel_Worksheet $sheet
     * @param int|string $startRow (1-based)
     * @param int $startOffsetY
     * @param int|string $endRow (1-based)
     * @param int $endOffsetY
     * @return int Vertical distance measured in pixels
     * @internal param int $startOffset Offset within start cell measured in 1/256 of the cell height
     * @internal param int $endOffset Offset within end cell measured in 1/256 of the cell height
     */
