...
class PHPExcel_Shared_Font
{
     ...
     * @param PHPExcel_Style_Font $defaultFont
     * @return int Column width
     * @internal param int $fontSize Font size (in pixels or points)
     * @internal param bool $fontSizeInPixels Is the font size specified in pixels (true) or in points (false) ?
     */
