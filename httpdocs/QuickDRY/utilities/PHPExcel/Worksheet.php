...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
	...
	*/
     ...
     *
     * @param int|string $pColumn Numeric column coordinate of the cell
     * @param int|string $pRow Numeric row coordinate of the cell
     * @param mixed $pValue Value of the cell
     * @param bool $returnCell Return the worksheet (false, default) or the cell (true)
     ...
     * @param int|string $pColumn Numeric column coordinate of the cell
     * @return PHPExcel_Worksheet_ColumnDimension
     * @internal param string $pRow Numeric row coordinate of the cell
     */
     ...
     * @return PHPExcel_Worksheet
     * @internal param PHPExcel_Style $value
     */
     ...
     *
     * @param int|string $pBefore Insert before this one
     ...
     *
     * @param int|string $pColumn Remove starting with this one
	...
	*/
     ...
     * @param string $pCoordinate
     * @return PHPExcel_Worksheet
     * @internal param string $pCell Cell (i.e. A1)
     */
...
//
     ...
     * @param string $pCoordinate
     * @return bool
     * @internal param string $pCellCoordinate
     */
