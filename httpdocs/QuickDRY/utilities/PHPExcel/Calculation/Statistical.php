...
class PHPExcel_Calculation_Statistical {
     ...
     * @internal param require $p p>0
     * @internal param require $q q>0
     */
     ...
     * @internal param require $x 0<=x<=1
     * @internal param require $p p>0
     * @internal param require $q q>0
     */
     ...
     * @return float
     * @internal param mixed $arg Data values
     */
     ...
     * @param int $rMax
     * @return float
     * @internal param bool $cumulative
     */
...
//			$CumPGuessMinus1 = $CumPGuess - $PGuess;
     ...
     * @return float
     * @internal param mixed $arg Data values
     * @internal param int $entry Position (ordered from the largest) in the array or range of data to return
     */
     ...
     * @return float
     * @internal param mixed $arg Data values
     * @internal param float $entry Percentile value in the range 0..1, inclusive.
     */
     ...
     * @return float
     * @internal param of $array number        An array of, or a reference to, a list of numbers.
     * @internal param The $number number whose rank you want to find.
     * @internal param The $number number of significant digits for the returned percentage value.
     */
     ...
     * @return float
     * @internal param mixed $arg Data values
     * @internal param int $entry Quartile value in the range 1..3, inclusive.
     */
     ...
     * @return float
     * @internal param mixed $arg Data values
     * @internal param int $entry Position (ordered from the smallest) in the array or range of data to return
     */
     ...
     * @return float
     * @internal param mixed $arg Data values
     * @internal param float $discard Percentage to discard
     */
     ...
     * @return float
     * @internal param float $value
     * @internal param float $alpha Alpha Parameter
     * @internal param float $beta Beta Parameter
     * @internal param bool $cumulative
     */
