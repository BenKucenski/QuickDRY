...
class PHPExcel_Calculation_MathTrig {
     ...
     * @internal param Values $array to calculate the Greatest Common Divisor
     */
     ...
     * @internal param Values $array to calculate the Lowest Common Multiplier
     */
     ...
     * @category Mathematical and Trigonometric Functions
     * @param $number
     * @param float|int $base The base of the logarithm. If base is omitted, it is assumed to be 10.
     * @return float
     * @internal param float $value The positive real number for which you want the logarithm
     */
     ...
     * @return float
     * @internal param float $x Input value to the power series
     * @internal param float $n Initial power to which you want to raise $x
     * @internal param float $m Step by which to increase $n for each term in the series
     * @internal param of $array mixed        Data Series
     */
     ...
     * SUMPRODUCT
     * @return float
     * @internal param mixed $value Value to check
     */
