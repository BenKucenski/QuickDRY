...
class PHPExcel_Calculation_DateTime
{
     ...
     * DATEDIF
     *
     * @param int $startDate Excel date serial value or a standard date string
     * @param int $endDate Excel date serial value or a standard date string
     * @param    string $unit
     ...
     * @param    int $endDays number of days for adjustment
     * @return    int|DateTime    Interval between the dates
     */
     ...
     * DAYOFMONTH
     *
     * @param int $dateValue Excel date serial value or a standard date string
     * @return int Day
     */
     ...
     *
     * @param int $dateValue Excel date serial value or a standard date string
     * @param bool|int $method Week begins on Sunday or Monday
     ...
     * MINUTEOFHOUR
     *
     * @param int $timeValue Excel time serial value or a standard time string
     * @return int Minute
     */
     ...
     * @return int Excel date serial value
     */
     ...
     * @param int $dateValue Excel date serial value or a standard date string
     * @param    int $adjustmentMonths Number of months to adjust by
     * @return int|DateTime Excel date serial value
     */
