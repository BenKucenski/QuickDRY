...
class PHPExcel_Calculation_DateTime {
     ...
     *
     * @param int|long $hour
     * @param int|long $minute
     * @param int|long $second
     * @return mixed Excel date/time serial value, PHP date/time serial value or PHP date/time object,
     *                        depending on the value of the ReturnDateType flag
     */
     ...
     * DATEDIF
     *
     * @param int|long $startDate Excel date serial value or a standard date string
     * @param int|long $endDate Excel date serial value or a standard date string
     * @param    string $unit
     ...
     * DAYOFMONTH
     *
     * @param int|long $dateValue Excel date serial value or a standard date string
     * @return int Day
     */
     ...
     * MINUTEOFHOUR
     *
     * @param int|long $timeValue Excel time serial value or a standard time string
     * @return int Minute
     */
