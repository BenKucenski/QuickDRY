...
class PHPExcel_Calculation_LookupRef {
     ...
     * @param Flag|int $relativity
     * @param A|bool $referenceStyle
     * @param Optional|string $sheetText
     * @return string
     * @internal param Flag $relativity indicating the type of reference to return
     *                                1 or omitted    Absolute
     *                                2                Absolute row; relative column
     *                                3                Relative row; absolute column
     *                                4                Relative
     * @internal param A $referenceStyle logical value that specifies the A1 or R1C1 reference style.
     *                                TRUE or omitted        CELL_ADDRESS returns an A1-style reference
     *                                FALSE                CELL_ADDRESS returns an R1C1-style reference
     * @internal param Optional $sheetText Name of worksheet to use
     */
     ...
     * @param An|null $cellAddress
     * @return int
     * @internal param An $cellAddress array or array formula, or a reference to a range of cells for which you want the number of rows
     */
     ...
     *
     * @param null|The $cellAddress
     * @param int|The $rows
     * @param int $columns
     * @param null|The $height
     * @param null|The $width
     * @return string A reference to a cell or range of cells
     * @internal param The $cellAddress reference from which you want to base the offset. Reference must refer to a cell or
     *                                range of adjacent cells; otherwise, OFFSET returns the #VALUE! error value.
     * @internal param The $rows number of rows, up or down, that you want the upper-left cell to refer to.
     *                                Using 5 as the rows argument specifies that the upper-left cell in the reference is
     *                                five rows below reference. Rows can be positive (which means below the starting reference)
     *                                or negative (which means above the starting reference).
     * @internal param The $cols number of columns, to the left or right, that you want the upper-left cell of the result
     *                                to refer to. Using 5 as the cols argument specifies that the upper-left cell in the
     *                                reference is five columns to the right of reference. Cols can be positive (which means
     *                                to the right of the starting reference) or negative (which means to the left of the
     *                                starting reference).
     * @internal param The $height height, in number of rows, that you want the returned reference to be. Height must be a positive number.
     * @internal param The $width width, in number of columns, that you want the returned reference to be. Width must be a positive number.
     */
     ...
     *
     * @param The $lookup_value
     * @param The $lookup_array
     * @param int|The $match_type
     * @return int The relative position of the found item
     * @internal param The $lookup_value value that you want to match in lookup_array
     * @internal param The $lookup_array range of cells being searched
     * @internal param The $match_type number -1, 0, or 1. -1 means above, 0 means exact match, 1 means below. If match_type is 1 or -1, the list has to be ordered.
     */
...
//				echo '$i='.$i.'<br />';
     ...
     * @param The $lookup_value
     * @param The $lookup_array
     * @param The $index_number
     * @param bool|Determines $not_exact_match
     * @return mixed The value of the found cell
     * @internal param The $lookup_value value that you want to match in lookup_array
     * @internal param The $lookup_array range of cells being searched
     * @internal param The $index_number column number in table_array from which the matching value must be returned. The first column is 1.
     * @internal param Determines $not_exact_match if you are looking for an exact match based on lookup_value.
     */
     ...
     * @param The $lookup_value
     * @param The $lookup_vector
     * @param null|The $result_vector
     * @return mixed The value of the found cell
     * @internal param The $lookup_value value that you want to match in lookup_array
     * @internal param The $lookup_vector range of cells being searched
     * @internal param The $result_vector column from which the matching value must be returned
     */
