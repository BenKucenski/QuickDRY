...
class PHPExcel_Calculation_Financial {
     ...
     * @param int $basis
     * @return float
     * @internal param issue $mixed The security's issue date.
     * @internal param firstinter $mixed The security's first interest date.
     * @internal param settlement $mixed The security's settlement date.
     * @internal param rate $float The security's annual coupon rate.
     * @internal param par $float The security's par value.
     * @internal param basis $int The type of day count to use.
     ...
     * @param int $month
     * @return float
     * @internal param cost $float Initial cost of the asset.
     * @internal param salvage $float Value at the end of the depreciation. (Sometimes called the salvage value of the asset)
     * @internal param life $int Number of periods over which the asset is depreciated. (Sometimes called the useful life of the asset)
     * @internal param period $int The period for which you want to calculate the depreciation. Period must use the same units as life.
     * @internal param month $float Number of months in the first year. If month is omitted, it defaults to 12.
     */
     ...
     *
     * @param float|int $nominal_rate Nominal interest rate
     ...
     *
     * @param float|int $rate Interest rate per period
     * @param    int $nper Number of periods
     * @param float|int $pmt Periodic payment (annuity)
     * @param float|int $pv Present Value
     * @param    int $type Payment type: 0 = at the end of each period, 1 = at the beginning of each period
     * @return float
     */
     ...
     * @param    int $nper Number of periods
     * @param    float $pv Present Value
     * @param float|int $fv Future Value
     * @param    int $type Payment type: 0 = at the end of each period, 1 = at the beginning of each period
     * @return float
     */
     ...
     *
     * @param float|int $effect_rate Effective interest rate
     * @param    int $npery Number of compounding payments per year
     * @return float
     */
     ...
     * @param Number $life
     * @return float
     * @internal param Initial $cost cost of the asset
     * @internal param Value $salvage at the end of the depreciation
     * @internal param Number $life of periods over which the asset is depreciated
     */
