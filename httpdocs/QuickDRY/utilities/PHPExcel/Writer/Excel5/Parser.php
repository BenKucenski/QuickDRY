...
class PHPExcel_Writer_Excel5_Parser
{
     ...
     *
     * @param $biff_version
     * @internal param int $byte_order The byte order (Little endian or Big endian) of the architecture
     ...
     * @param $errorCode
     * @return string
     * @internal param mixed $num an error codefor conversion to its ptg value
     */
