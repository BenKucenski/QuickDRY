...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
     ...
     * @internal param int $BIFF_verions BIFF version
     */
     ...
     * storage.
     *
     * @param null $pWorksheetSizes
     * @return string Binary data for workbook stream
     * @internal param array $worksheetSizes The sizes in bytes of the binary worksheet streams
     */
