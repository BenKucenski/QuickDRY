...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
     ...
     * @param $preCalculateFormulas
     * @param PHPExcel_Worksheet $phpSheet
     * @internal param string $tempDir The temporary directory to be used
     */
     ...
     * @param $xfIndex
     * @return int
     * @internal param mixed $format The optional XF format
     */
     ...
     */
    private function _writeString($row, $col, $str, $xfIndex = null)
    {
        if ($this->_BIFF_version == 0x0600) {
     ...
     * @param $xfIndex
     * @return int
     * @internal param mixed $format The XF format for the cell
     */
     ...
     * @param $xfIndex
     * @return int
     * @internal param mixed $format The XF format
     */
     ...
     * @param float|int $scale_x The horizontal scale
     * @param float|int $scale_y The vertical scale
     * @throws Exception
     */
