...
class PHPExcel_Calculation {
	 ...
	 *	@var array
	 */
	private static $_calculationCache = [];
	...
	public function calculateCellValue(PHPExcel_Cell $pCell = null, $resetLog = true) {
		if ($resetLog) {
			...
			$this->debugLog = $this->debugLogStack = [];
...
//						echo 'Cache has expired<br />';
     ...
     * @param $matrix1Rows
     * @param $matrix1Columns
     * @param $matrix2Rows
     * @param $matrix2Columns
     */
    ...
    private function _parseFormula($formula, PHPExcel_Cell $pCell = null) {
		...
		$operatorAssociativity	= ['^' => 0,															//	Exponentiation
		...
		$comparisonOperators	= ['>' => true, '<' => true, '=' => true, '>=' => true, '<=' => true, '<>' => true];

		//	Operator Precedence
		//	This list includes all valid operators, whether binary (including boolean) or unary (such as %)
		//	Array key is the operator, the value is its precedence
		$operatorPrecedence	= [':' => 8,																//	Range
									'|' => 7,																//	Intersect
									'~' => 6,																//	Negation
									'%' => 5,																//	Percentage
									'^' => 4,																//	Exponentiation
