	...
	if(n_value=="")
	{
		if(elementId!=null)
		{
			if($("#"+elementId).type == "text")
			{
				...
				{
					$("#"+elementId).val(prefix+"0");
				}
			}
		else
			$("#"+elementId).html(prefix+"0");
		}
		return;
	}
...
function DialogIsOpen(dialog_id) {
    ...
    if($("#" + dialog_id).hasClass('in')) {
        return true;
    }

	res = $("#" + dialog_id).hasClass("ui-dialog-content") && $("#" + dialog_id).dialog( "isOpen" )===true;
    return res;
}
